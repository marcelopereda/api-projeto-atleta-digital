...
<body style="background-color: rgba(179, 248, 225, 0.2);">
    ...
    <div class="container py-5 card mt-4 bg-white rounded-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="text-dark"><i class="fas fa-vr-cardboard me-2"></i>Produtos Cadastrados</h2>
            <a href="<?php echo $_SESSION["url"]; ?>/RA/index.php" class="btn btn-outline-success shadow-sm">
                <i class="fas fa-arrow-left me-2"></i>Voltar
            </a>
            <div>
                <!-- Botões de ações -->
                <a href="../RA/detalhe-produto.php" class="btn btn-outline-primary shadow-sm"><i class="fas fa-plus"></i> Novo Produto</a>
                <a href="../RA/exportar.php" class="btn btn-outline-success shadow-sm"><i class="fas fa-file-excel"></i> Exportar Excel</a>
                <a href="../RA/exportar.pdf.php" class="btn btn-outline-danger shadow-sm"><i class="fas fa-file-pdf"></i> Exportar PDF</a>

                <!-- Formulário de pesquisa -->
                <form class="d-inline-block" method="GET" action="../RA/listar-produtos.php">
                        ...
                        foreach ($_SESSION["produtos-RA"] as $key => $product) {
                            ...
                            echo '
                                <tr>
                                    ...
                                    <td>
                                        <a href="../RA/detalhe-produto.php?key=' . $key . '" class="btn btn-sm btn-outline-primary btn-sm me-2 mb-2"><i class="fas fa-edit"></i> Editar</a>
                                        <a href="../RA/remover.php?key=' . $key . '" class="btn btn-sm btn-outline-danger btn-sm me-2 mb-2"><i class="fas fa-trash"></i> Excluir</a>
                                    </td>
                                </tr>';
                        }
