    ...
    if (!empty($_SESSION["produtos-natacao"])) {
        ...
        if($produtoEncontrado) {
            ...
            <tr>
                ...
                <td>
                    <a href="../natacao/detalhe-produto.php?key=' . $idBuscado . '" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Editar</a>
                    <a href="../natacao/remover.php?key=' . $idBuscado . '" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Excluir</a>
                </td>
            </tr>';
        } else {
    ...
    if (!empty($_SESSION["produtos-natacao"])) {
        foreach ($_SESSION["produtos-natacao"] as $key => $product) {
            ...
            <tr>
                ...
                <td>
                    <a href="../natacao/detalhe-produto.php?key=' . $key . '" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Editar</a>
                    <a href="../natacao/remover.php?key=' . $key . '" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Excluir</a>
                </td>
            </tr>';
        }
    } else {
