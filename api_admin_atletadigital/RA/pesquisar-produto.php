    ...
    if (!empty($_SESSION["produtos-RA"])) {
        ...
        if($produtoEncontrado) {
            ...
            <tr>
                ...
                <td>
                    <a href="../RA/detalhe-produto.php?key=' . $idBuscado . '" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Editar</a>
                    <a href="../RA/remover.php?key=' . $idBuscado . '" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Excluir</a>
                </td>
            </tr>';
        } else {
    ...
    if (!empty($_SESSION["produtos-RA"])) {
        foreach ($_SESSION["produtos-RA"] as $key => $product) {
            ...
            <tr>
                ...
                <td>
                    <a href="../RA/detalhe-produto.php?key=' . $key . '" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Editar</a>
                    <a href="../RA/remover.php?key=' . $key . '" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Excluir</a>
                </td>
            </tr>';
        }
    } else {
