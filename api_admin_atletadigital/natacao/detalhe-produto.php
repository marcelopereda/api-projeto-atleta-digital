...
$pagina = "produtos-natacao";

if (isset($_GET["key"])) {
  $key = $_GET["key"];
  $product = $_SESSION["produtos-natacao"][$key];
}
...
<body style="background-color:rgba(179, 248, 225, 0.2);">
  ...
  <div class="form-container mt-5 ">
    <h1 class="text-center  text-white mb-4"><i class="fas fa-swimmer  me-2"></i>Cadastro de Produto</h1>
    <p class="text-center  text-white">Preencha os campos abaixo para cadastrar um novo produto do setor de natação.</p>
    <a href="<?php echo $_SESSION["url"]; ?>/natacao/index.php" class="btn  text-white btn-outline-success mb-2 ">
      <i class="fas fa-arrow-left me-2  text-white"></i>Voltar
    </a>
    <div class="card shadow-lg p-4">
      <h2 class="mb-2 text-dark"><i class="fas fa-swimmer "></i></h2>
      <form method="POST" action="../natacao/cadastrar.php" enctype="multipart/form-data">
        <?php if (isset($key)) { ?>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            <a href="../natacao/listar-produtos.php" class="btn btn-outline-secondary w-100  shadow-sm">
